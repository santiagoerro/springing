...
plt.figure()
plt.title('Heave RAOs in head waves for both backbones')
plt.plot(shipLengthOverWavelength, heaveAmplitudes[:, 1] / waveAmplitude, 'ko', label = 'Base backbone')
plt.plot(shipLengthOverWavelength, heaveAmplitudesLessStiff[:, 1] / waveAmplitude, 'bx', label = 'Less stiff backbone')
plt.xlabel('Ship length / wavelength')
plt.ylabel('Heave RAO [m/m]')
plt.legend()
plt.savefig('application/plots/heaveRAOHeadComparison.png', dpi = 200, bbox_inches = 'tight')

plt.figure()
plt.title('Pitch RAOs in head waves for both backbones')
plt.plot(shipLengthOverWavelength, pitchAmplitudes[:, 1] / (waveAmplitude * waveWavenumbers), 'ko', label = 'Base backbone')
plt.plot(shipLengthOverWavelength, pitchAmplitudesLessStiff[:, 1] / (waveAmplitude * waveWavenumbers), 'bx', label = 'Less stiff backbone')
plt.xlabel('Ship length / wavelength')
plt.ylabel('Pitch RAO [rad/rad]')
plt.legend()
plt.savefig('application/plots/pitchRAOHeadComparison.png', dpi = 200, bbox_inches = 'tight')
...
plt.figure()
plt.title('Two-node vertical bending transfer function')
...
plt.figure()
plt.title('H1T1 transfer function')
...
plt.figure()
plt.title('Heave RAOs in 45 degree bow waves, both backbones')
plt.plot(shipLengthOverWavelength, heaveAmplitudes[:, 0] / waveAmplitude, 'ko', label = 'Base backbone')
plt.plot(shipLengthOverWavelength, heaveAmplitudesLessStiff[:, 0] / waveAmplitude, 'bx', label = 'Less stiff backbone')
plt.xlabel('Ship length / wavelength')
plt.ylabel('Heave RAO [m/m]')
plt.legend()
plt.savefig('application/plots/heaveRAOBowComparison.png', dpi = 200, bbox_inches = 'tight')

plt.figure()
plt.title('Pitch RAOs in 45 degree bow waves, both backbones')
plt.plot(shipLengthOverWavelength, pitchAmplitudes[:, 0] / (waveAmplitude * waveWavenumbers), 'ko', label = 'Base backbone')
plt.plot(shipLengthOverWavelength, pitchAmplitudesLessStiff[:, 0] / (waveAmplitude * waveWavenumbers), 'bx', label = 'Less stiff backbone')
plt.xlabel('Ship length / wavelength')
plt.ylabel('Pitch RAO [rad/rad]')
plt.legend()
plt.savefig('application/plots/pitchRAOBowComparison.png', dpi = 200, bbox_inches = 'tight')
...
plt.ylabel(r'$\mathregular{CM_b}$')
plt.legend()
plt.savefig('application/plots/bendingMomentCoefsBowComparison.png', dpi = 200, bbox_inches = 'tight')

plt.figure()
plt.title('Midships torsional moment coefficient for different 45 degree bow waves, both backbones')
plt.plot(shipLengthOverWavelength, torsionMomentCoefs[:, 0], 'ko', label = 'Base backbone')
plt.plot(shipLengthOverWavelength, torsionMomentCoefsLessStiff[:, 0], 'bx', label = 'Less stiff backbone')
plt.xlabel('Ship length / wavelength')
plt.ylabel(r'$\mathregular{CM_t}$')
plt.legend()
plt.savefig('application/plots/torsionMomentCoefsBowComparison.png', dpi = 200, bbox_inches = 'tight')
